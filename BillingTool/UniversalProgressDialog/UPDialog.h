...
class CUPDialog : CInitCommonControls<CUPDIALOG_CONTROL_CLASSES>
{
	...
	bool	m_bAutoIncrement;		//is auto increment progress  position
...
public:
	...
	//		autoIncr: auto update  progress position
	CUPDialog(HWND hParentWnd,LP_CUPDIALOG_USERPROC lpUserProc,LPVOID lpUserProcParam,LPCTSTR lpszDlgTitle=_T("Please Wait.."),bool bAllowCancel=true, bool autoIncrement = false);
